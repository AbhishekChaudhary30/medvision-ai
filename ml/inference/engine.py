...
class InferenceEngine:
    ...
    def predict(self, image: Image.Image, sample_id: str = "unknown", explain: bool = False, explain_method: str = "gradcam") -> InferenceResult:
        ...
        if explain:
            ...
            with torch.enable_grad():
                ...
                explanation = self.explainability_svc.generate_explanation(
                    input_tensor=input_tensor_explain, original_image=image_rgb, target_class=class_index, method=explain_method
                )
