...
class ExplainabilityService:
    ...
    def generate_explanation(
        self, input_tensor: torch.Tensor, original_image: Image.Image, target_class: int, method: str = "gradcam"
        ...
        try:
            ...
            with cam_algorithm(model=self.model, target_layers=self.target_layers) as cam:
                ...
                return ExplanationResult(
                    heatmap=grayscale_cam.tolist(), overlay_image_base64=img_str, method=method, target_layer=self.target_layers[0].__class__.__name__
                )
