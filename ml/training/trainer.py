...
class Trainer:
    ...
    def save_checkpoint(self, epoch: int, metrics: dict, is_best: bool = False, metadata: dict | None = None) -> None:
    ...
    def fit(self, num_epochs: int, mlflow_run=None, metadata: dict | None = None) -> dict:
