...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--manifest-path", type=Path, default=Path("data/processed/split_manifest.csv"),
                        help="Path to the split manifest CSV.")
    parser.add_argument("--checkpoint-dir", type=Path, default=Path("ml/models/checkpoints"),
